...
public class OptionalTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        //Paths.get("resource/spring_boot.txt").toAbsolutePath()

        Optional<String> optionalValue = wordList.stream().filter(s -> s.contains("work")).findFirst();
        System.out.println(optionalValue.orElse("No word") + " contains work.");
    ...
    public static Optional<Double> inverse(Double x) {
        Optional<Double> r = x == 0 ? Optional.empty() : Optional.of(1 / x);
